...
for k in range(loops):
    ...
    isoForest = IsolationForest(n_estimators=100, contamination=0.1, max_features=24, random_state=42)
    ...
    # print(fit_pred)
    scores_prediction = isoForest.decision_function(all_features_train)
    print(scores_prediction)

    y_pred = isoForest.predict(all_features_test)
    #print(pred)
    ...
    cl_re = classification_report(Y, y_pred)
